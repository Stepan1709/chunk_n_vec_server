...
# Пытаемся импортировать из secrets.py
try:
    from secrets import (
    ...
    logging.warning("secrets.py not found, using default configuration")
except AttributeError as e:
    # Если в secrets.py не все переменные определены
    ...
    logging.warning("Some variables missing in secrets.py, using defaults for missing ones")